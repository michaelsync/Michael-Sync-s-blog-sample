...
<body>
    <form id="Form1" method="post" runat="server">
        <h2>DataList Example #2</h2>
        <p>In this example, the DataList is an Anthem control, and all of the buttons (Edit, Update, Cancel)
        are normal ASP.NET controls. The Anthem.DataList will convert the ASP.NET controls to use callbacks.
        See <a href="DataList.aspx">DataList Example #1</a> for an example using Anthem buttons.</p>
