...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder">
    ...
    <p>
        There are only two Anthem controls on this page: the Anthem.Panel (blue border)
        that surrounds all the other controls, and an Anthem.Button in the bottom right
        corner to demonstrate that you can embed Anthem control inside of an Anthem.Panel.
        When AddCallBacks is true, the Anthem.Panel will convert all of the child controls
        to use callbacks instead of postbacks. The Anthem.Panel also has Pre- and PostCallBackFunctions
    ...
    <asp:CheckBox ID="addCallBacks" runat="server" Text="AddCallBacks" Checked="true"
        ToolTip="If AddCallBacks is true, the Anthem.Panel will convert all child ASP.NET WebControls to use callbacks." />
